...
<br>Now we will do the Planning Task<br><br>
<br><b>INSTRUCTIONS (PLEASE READ CAREFULLY)</b><br><br>
Your task is to exit the maze by reaching the red square in as few steps as possible. <br><br>
There are 3 practice mazes and 12 test mazes. <br><br>
...
<form name="frm" action="test.php" method="post" onsubmit="return validateForm()">
  ...
  <input type="text" name="showEndNext" hidden><input type="text" name="firsttrial" hidden><input type="submit" value="Continue"/>
</form>
...
function validateForm() {
    ...
    document.forms["frm"]["showEndNext"].value = showEndNext;
    return true;  
}
